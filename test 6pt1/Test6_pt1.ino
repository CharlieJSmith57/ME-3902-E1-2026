...
void setup() {
  ...
  //analogSetCycles(8);  //ESP32 ADC reading cycles - left commented: not required, errors on newer ESP32 cores
...
void loop() {
  ...
  //Steinhart-Hart Equation - resistance to Kelvin - degree C
